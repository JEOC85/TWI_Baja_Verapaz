...
map.getView().fit([-10113720.600474, 1660807.579400, -10009107.547466, 1731028.941442], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">INDICE DE HUMEDAD TOPOGRAFICA DEPARTAMENTO DE BAJA VERAPAZ</h2>';
        return titleElement;
    })(),
